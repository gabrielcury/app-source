...
export class HomePage {
  ...
  login() {
    ...
    loader.dismiss();
    document.getElementById('footerApp').style.cssText = 'height: 0px; visibility: hidden;';
  }
  ...
  openFile(file, index) {
    ...
    //seta um tamanho  style.cssText = cssString;
    //document.getElementById('footerApp').style.cssText = 'height: 200px !important; visibility: visible !important; bottom: 0px !important;';
    document.getElementById('footerApp').removeAttribute("style");
    //document.getElementById('footerApp').style.cssText = 'opacity: 1;';
